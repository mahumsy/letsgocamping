Feature: test the create account functionality of website
  ...
  Scenario: Passwords field is empty
    ...
    Then I get "Error: Password field cannot be empty" message
  ...
  Scenario: Passwords doesn't match
    ...
    And I press the Create User button
    Then I get "Error: Password and confirm password must match" message
  ...
  Scenario: Password doesn't contain uppercase
    ...
    And I confirm the password "happy1"
    And I press the Create User button
    Then I get "Error: Password must have one uppercase character" message
  ...
  Scenario: Password doesn't contain lowercase
    ...
    And I confirm the password "HAPPY1"
    And I press the Create User button
    Then I get "Error: Password must have one lowercase character" message
  ...
  Scenario: Password doesn't contain number character
    ...
    And I press the Create User button
    Then I get "Error: Password must have one numerical character" message
  ...
  Scenario: username exists
    ...
    And I confirm the password "Happy1"
    And I press the Create User button
    Then I get "Error: Username exists" message
